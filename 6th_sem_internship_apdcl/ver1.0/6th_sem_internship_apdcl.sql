...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2023 at 07:15 PM
...
(230700, 'Deepa Choudhury', 'HNo: 22, Fatasil Ambari, Guwahati', '9786410967', 'prepaid', 30010052),
(230701, 'Upama Das', 'HNo: 13, Beltola, Guwahati ', '7856901245', 'prepaid', 30010050),
(230702, 'Kapil ', 'HNo: 31, Maligaon, Guwahati', '6789023451', 'postpaid', 30010051);
...
--
ALTER TABLE `complaints`
  MODIFY `complaint_number` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
